...
const BASE_URL = 'https://ddlong07.click'; 
...
export const courseEndpoints = {
  ...
  PUBLISH_COURSE_API: BASE_URL + "/courses/edit/done", // + ?id=&&isPublic=
  // section 
...
export const catalogData = {
  CATALOGPAGEDATA_API: BASE_URL + "/category/page-detail/analysis",
}
// CONTACT-US API
