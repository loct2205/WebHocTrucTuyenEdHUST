        ...
        <div className="bg-richblack-800 mx-7 rounded-3xl mb-10">
            <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
                <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
                    ...
                    {/* Section 1 */}
                    <div className="lg:w-[30%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-10 lg:pl-10 gap-3">
                        <div className="w-[20%] flex flex-col gap-3 lg:w-[100%] mb-7 lg:pl-0">
                            <img src={""} alt="" className="object-contain" />
                            <h1 className="text-richblack-50 font-semibold text-[16px]">EdHUST-BECOME BETTER</h1>
                            <div className="flex flex-col gap-2">
                                {["08xxxxxxxx", "loct2205@gmail.com", "TP. Hà Nội"].map((ele, i) => {
                                    return (
                                        <div
                                            key={i}
                    ...
                    {/* Section 2 */}
                    <div className="lg:w-[70%] flex flex-wrap flex-row justify-between pl-3 lg:pl-20 lg:pr-5 gap-3">
                        {FooterLink2.map((ele, i) => {
                            return (
                                <div key={i} className="w-[30%] lg:w-[32%] mb-7 lg:pl-0">
